...
@section('page-title',__('admin.header.industries'))
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-header">
                    <h1 class="page-title">
                        {{ __('admin.header.industries') }}
                    </h1>
                    @can('manage industries')
                    <a href="{{ route('admin.industry.create') }}" class="btn btn-outline-primary ml-auto"><i class="fe fe-plus mr-2"></i>{{ __('admin.organizations.new-industry') }} </a>
                    @endcan
                </div>
                ...
                <div class="card">
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap datatable" id="industries-table">
                            <thead>
                                <tr>
                                    <th>{{ __('admin.organizations.order') }}</th>
