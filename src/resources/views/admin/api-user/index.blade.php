...
@section('page-title', __('admin.api-access.title'))
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-header">
                    <h1 class="page-title">
                        {{ __('admin.api-access.title') }}
                    </h1>
                    @can('manage api users')
                    <a href="{{ route('admin.api-user.create') }}" class="btn btn-outline-primary ml-auto"><i class="fe fe-plus mr-2"></i> {{ __('admin.api-access.new-api-user') }}</a>
                    @endcan
                </div>
                ...
                <div class="card">
                    <div class="table-responsive">
                        <table class="table card-table table-vcenter text-nowrap datatable" id="api-users-table">
                            <thead>
                                <tr>
