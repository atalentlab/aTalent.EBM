...
class StoreMyOrganizationRequest extends FormRequest
{
    /**
    ...
    {
        return Auth::guard('admin')->user()->hasPermissionTo('manage my organization');
    }
    ...
    {
        session()->flash('error', 'There were errors while saving your organization.');
